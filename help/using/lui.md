...
* 内容片段模板取代了AEM 6.3中的内容片段模型。 将基于旧版模板的内容片段迁移到AEM as a Cloud Service会将这些片段保留为正常功能，但不可能基于旧版模板创建片段。 也无法使用 AEM GraphQL 提供这些片段，它需要内容片段模型作为架构。
...
* `I18n`词典必须通过CI/CD管道来自Git。[文档](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/release-notes/aem-cloud-changes#apps-libs-immutable)
