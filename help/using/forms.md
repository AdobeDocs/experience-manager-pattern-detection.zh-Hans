...
* 元数据折叠没有替换项。 将其从表单中删除，然后再将其迁移到Cloud Service。(METADATA_ACCORDION_FORM_CONTAINER)
...
* 对基于 XFA 的自适应表单的支持并非现成可用。 如果您要使用基于XFA的Adaptive Forms，请联系Adobe支持并提供您的用例和特定要求的详细信息。(XFA_BASED_FORM， XDP_BASED_FORM)
