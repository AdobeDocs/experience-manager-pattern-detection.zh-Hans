...
* Experience Manager可能无法处理非常高分辨率的PSB文件。 如果未对Experience Manager服务器进行适当的基准测试，则使用ImageMagick处理大型文件的客户可能会面临性能影响。
...
* 如果您计划处理大量大型PSD或PSB文件，请联系Adobe客户支持。 Experience Manager可能无法处理超过30000 x 23000像素的超高分辨率PSB文件。 请参考 [文档](https://experienceleague.adobe.com/docs/experience-manager-64/assets/extending/best-practices-for-imagemagick.html).
